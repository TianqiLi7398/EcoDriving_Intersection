...
class vertex:
    def __init__(self, x, v, t):
        ...
        self.v = v
        self.t = t
        self.out_edge = []      # edge will be tuples in [v2, dt, cost, action]
        self.in_edge = []       # edge will be tuples in [v1, dt, cost, action]
        self.policy = -1        # policy will be the index of out_edge list
        self.h = 9999           # utility function
